...
public class MessageService extends Service implements SinchClientListener {
    ...
    private static final String APP_KEY = "cb0b2f41-18cf-4bb2-9622-5ed99d18b7a0";
    private static final String APP_SECRET = "1kmxhImel0e5VfK7BCaYWQ==";
    ...
    private Intent broadcastIntent = new Intent("www.wit.ie.connect.chat.ListUsersActivity");
